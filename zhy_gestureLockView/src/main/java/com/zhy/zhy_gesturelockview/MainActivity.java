        ...
        extends Activity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        mGestureLockViewGroup.setAnswer(new int[]{1,
                                                  2,
                                                  3,
                                                  4,
                                                  5});
        mGestureLockViewGroup.setOnGestureLockViewListener(new OnGestureLockViewListener() {
            ...
            {
                Toast.makeText(MainActivity.this, "错误5次...", Toast.LENGTH_SHORT)
                     .show();
            ...
            {
                Toast.makeText(MainActivity.this, matched + "", Toast.LENGTH_SHORT)
                     .show();
            }
